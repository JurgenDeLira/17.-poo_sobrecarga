...
/* En vez de a cada uno ponerle Calculadora al principio, puedes simplemente importar:
import static org.jdelira.poosobrecarga.Calculadora.*;
 */
public class EjemploSobrecarga {
    public static void main(String[] args) {
        ...
        System.out.println("sumar float + n in: " + Calculadora.sumar(10.5F, 5, 9, 15));
